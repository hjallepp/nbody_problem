...
public class SimBH {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Lib.resetOutputFile("raw/time_bh_serial.txt");
        Lib.resetOutputFile("raw/time_bh_parallel.txt");

        Lib.resetOutputFile("raw/data_bh_serial.ods");
        Lib.resetOutputFile("raw/data_bh_parallel.ods");

        /**
         * Run BHSer simulations
         */
        for (int b = 0; b < 3; b++) {
